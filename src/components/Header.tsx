      ...
      <div id="nav" className="flex w-full justify-between">
        ...
        <button
          className="hidden md:flex justify-center items-center 2xl:mr-[346px] w-[188px] h-[44px] p-[10px] gap-[10px] mt-[31px] 
           ...
           before:transition-all before:duration-500 hover:text-white hover:shadow-[#648e71] hover:before:left-0 hover:before:w-full mac:h-[64px] mac:w-[288px] mac:text-[24px] "
        >
