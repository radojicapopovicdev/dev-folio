const HeroAbout = () => {
  return (
    <div className="3xl:h-[100vh] 2xl:h-[100vh] xl:h-[100vh] lg:h-[100vh] sm:h-[60vh] md:h-[80vh] bg-[#000000] pt-[150px]">
      <p
        className="text-white 2xl:text-[212px] font-bigs 2xl:ml-[346px] 3xl:ml-[650px] xl:text-[180px] 
   ...
   mac:text-[350px] mac:ml-[650px] ultrawide:ml-[850px] sm:text-[80px] sm:ml-[55px] sm:mt-[-80px] smx:mt-[-80px] smx:text-[80px] smx:ml-[40px]"
      ...
      <p
        className="absolute text-white 2xl:text-[212px] font-bigs 2xl:ml-[1023px] 2xl:mt-[-320px] 3xl:ml-[650px] xl:text-[180px] 
   xl:ml-[300px] xl:mt-[-80px] md:text-[100px] md:ml-[70px] lg:ml-[200px]
   mac:text-[350px] mac:ml-[650px] ultrawide:ml-[850px] sm:text-[80px] sm:ml-[55px] sm:mt-[-80px] smx:mt-[-80px] smx:text-[80px] smx:ml-[40px]"
      >
        I'M
   ...
   mac:text-[350px] mac:ml-[650px] ultrawide:ml-[850px] sm:text-[80px] sm:ml-[55px] sm:mt-[-80px] smx:mt-[-80px] smx:text-[80px] smx:ml-[40px]"
      ...
      <p
        className="text-white/70 2xl:text-[16px] font-karla 2xl:w-[292px] 2xl:ml-[1023px] 2xl:mt-[200px] 3xl:ml-[1650px] xl:text-[12px]
