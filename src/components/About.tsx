const About = () => {
  return (
    ...
    >
      ...
      sm:text-[64px] sm:ml-[45px] smx:mt-[240px] smx:text-[64px] smx:ml-[45px] 3xl:ml-[1150px]  "
      >
        ABOUT ME
      </p>
      {/* TEXT */}
      ...
      sm:mt-[470px] sm:w-[284px] sm:ml-[45px] smx:mt-[370px] smx:w-[284px] smx:ml-[45px] text-left 3xl:ml-[1000px] "
      >
      ...
      <img
        ...
        alt="vector"
        className="absolute 2xl:ml-[1346px] 2xl:mt-[-20px] sm:hidden smx:hidden 3xl:block 2xl:block xl:block  ultrawide:block mac:block lg:block md:block 3xl:ml-[1750px] 3xl:mt-[-135px] "
      />
      <img
