const Hero = () => {
  return (
    ...
    >
      ...
      <div
        id="code1"
        className="abpsolute 2xl:ml-[600px] 2xl:mt-[-280px] 3xl:ml-[850px] mac:ml-[920px] lg:ml-[280px]  lg:mt-[-420px]
         md:mt-[-420px] md:ml-[220px] "
      >
      ...
      <div
        id="code2"
        className="abpsolute 2xl:ml-[1350px] 2xl:mt-[-150px] 3xl:ml-[1650px] mac:ml-[1850px] lg:ml-[600px]  lg:mt-[-150px] 
         md:mt-[-120px] md:ml-[450px]"
      >
